...
# ── Save ─────────────────────────────────────────────────────────────
svg_path = pathlib.Path(__file__).parent / 'meter_scale_cricut.svg'
...
png_path = pathlib.Path(__file__).parent / f'meter_scale_cricut_{_fmt(PLATE_W/10)}x{_fmt(PLATE_H/10)}cm.png'
